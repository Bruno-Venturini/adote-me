                ...
                <div className="bg-white flex artboard grid grid-cols-5 grid-flow-row phone-square-lg place-content-baseline ">
                    ...
                    <div className="mt-4 row-start-2 col-start-2 col-span-2 flex place-content-start items-center">
                        <input type="text" placeholder="Digite seu nome..."
                               className="bg-primary input input-md input-bordered w-8/12 max-w-xs placeholder-gray-400 text-black"/>
                    </div>
                    ...
                    <div className="mt-4 row-start-4 col-start-2 col-end-5 flex place-content-start items-center">
                        <input type="text" placeholder="Digite seu endereço..."
                               className="bg-primary input input-md input-bordered w-full placeholder-gray-400 text-black"/>
                    </div>
                    <div className="mt-4 row-start-5  col-start-2 col-span-2 flex place-content-start items-center">
                        <input type="password" placeholder="Digite sua senha..."
                               className="bg-primary input input-md input-bordered w-8/12 placeholder-gray-400 text-black"/>
                    </div>
                    <div className="mt-4 row-start-6 col-start-2 col-span-2 flex place-content-start items-center">
                        <select className="bg-primary select w-8/12 text-black max-w-xs selected">
                    ...
                    <div className="row-start-7 col-start-3 mt-4 flex items-center place-content-center">
                        <div>
                            <button className="btn btn-accent">Cadastrar-se</button>
                        </div>
                    </div>
                </div>
            </div>
